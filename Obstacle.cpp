...
Obstacle::Obstacle(b2World& world, b2Vec2 position, float width, float height)
{
	// Define Body
	b2BodyDef bodyDef;
...
Obstacle::Obstacle(b2World& world, b2Vec2 position, std::vector<tmx::Vector2f> objectPoints, tmx::Object::Shape shape)
{
	// Define Body
	b2BodyDef bodyDef;
